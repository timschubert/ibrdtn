...
namespace ibrcommon {
	...
	public:
		...
		virtual ssize_t send(const char *data, size_t len, int flags = 0) throw (socket_exception);
		virtual ssize_t recv(char *data, size_t len, int flags = 0) throw (socket_exception);
